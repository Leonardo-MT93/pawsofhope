      ...
      <div className="relative bg-gradient-to-t from-gray-900/50 to-gray-900/25  h-[500px] pt-64">
        <div className="p-4 sm:p-6">
          ...
          <div className="w-full flex justify-evenly ">
            <Link
              to={`https://api.whatsapp.com/send?phone=+5401123937902&text=Hola,%20te%20contacto%20por%20${name}%20-%20${id}%20desde%20PorEllosEzeiza%20.%20Me%20gustaría%20adoptar%20%F0%9F%92%99`}
              target="_blank"
            ...
            <Link
              to={`https://api.whatsapp.com/send?phone=+5401123937902&text=Hola,%20te%20contacto%20por%20${name}%20-%20${id}%20desde%20PorEllosEzeiza%20.%20Me%20gustaría%20brindar%20tránsito%20%F0%9F%92%99`}
              target="_blank"
              rel="noopener noreferrer"
            >
